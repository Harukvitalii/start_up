...
setup(
  name = 'pakagename',         # How you named your package folder (MyLib)
  packages = ['pakagename'],   # Chose the same as "name"
  version = '0.0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = "This pakage helps ...",   # Give a short description about your library
  ...
  download_url = 'https://github.com/Harukvitalii/....',    # I explain this later on
